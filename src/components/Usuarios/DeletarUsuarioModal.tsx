			...
			>
				...
				<div className="relative px-6 pt-6 pb-0">
					<div className="flex gap-4 items-start">
						{/* Ícone de Delete */}
						<div className="flex-shrink-0 w-12 h-12 bg-[#FEE4E2] border-8 border-[#FEF3F2] rounded-[28px] flex items-center justify-center">
						...
						<div className="flex-1 min-w-0">
							<h3 className="font-['Poppins'] font-semibold text-lg text-[#181D27] mb-1">
								Deletar usuário
							</h3>
							<p className="font-['Poppins'] font-normal text-sm text-[#535862] leading-5">
					...
					<button 
						onClick={onClose}
						className="absolute top-3 right-3 p-2.5 rounded-lg hover:bg-gray-100 transition-colors"
					>
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div className="flex items-center gap-3">
						...
						<div className="flex items-center gap-2">
							...
							<label 
								...
								className="font-['Poppins'] font-medium text-sm text-[#414651] cursor-pointer select-none"
							>
						...
						<div className="flex gap-3 ml-auto">
							<button
								onClick={onClose}
								className="px-[18px] py-2.5 bg-white border border-[#D5D7DA] rounded-lg shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] font-['Poppins'] font-semibold text-base text-[#414651] hover:bg-gray-50 transition-colors"
							>
								Cancelar
							</button>
							<button
								onClick={handleConfirm}
								className="px-[18px] py-2.5 bg-[#9b0103] border border-[#9b0103] rounded-lg shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] font-['Poppins'] font-semibold text-base text-white hover:bg-[#7a0102] transition-colors"
							>
								Deletar
							</button>
						</div>
