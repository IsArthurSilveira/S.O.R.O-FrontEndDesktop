...
const VerificacaoCodigo: React.FC = () => {
    ...
    return (
        ...
        <div className="flex h-screen bg-white">
            ...
            {/* 1. Coluna da Esquerda (Layout Lateral) - Estilo V2 */}
            ...
            <div className="flex flex-col justify-center items-center w-full lg:w-1/2 p-8 bg-white">
                <div className="w-full max-w-md mx-auto"> 
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        {/* Campo E-mail (Mantido para a lógica da API) */}
                        <div>
                            ...
                            <input
                                ...
                                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#1a2b5e] focus:border-[#1a2b5e] sm:text-sm"
                                placeholder="Insira seu e-mail"
                            />
                        </div>

                        {/* Campos de Código (OTP) - Estilo V2 */}
                        <div className='pt-4'>
                        ...
                        {/* Mensagem de sucesso/erro (Usando Alert MUI) */}
                        {message && (
                        ...
                        {/* Botão de Recuperar senha (Estilo V2 com lógica de submissão do desktop) */}
                        <div>
                            <button
                                type="submit"
