...
const EsqueciSenha: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Note: isSubmitting é desativado no finally se houver erro, ou no timeout se for sucesso.
  };

  return (
    // Container principal: tela cheia (h-screen) e layout flexível (flex) - Estilo V2
    <div className="flex h-screen bg-white">
      {/* Coluna da Esquerda (Layout Lateral) - Estilo V2 */}
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 p-8 bg-white">
        <div className="w-full max-w-sm mx-auto">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Exibição de Mensagem (Usando Alert MUI e lógica desktop) */}
            {message && (
